                ...
                if (vsData?.data) {
                    ...
                    for (const m of media) {
                        for (const res of m.resources) {
                            if (formatType === 'audio' && m.type === 'audio' && res.download_url && res.download_url.includes('googlevideo.com')) {
                                streamUrl = res.download_url;
                            }
                            if (formatType === 'video' && m.type === 'video' && res.download_url && res.download_url.includes('googlevideo.com')) {
                                streamUrl = res.download_url;
                            }
                        }
                    }
